        ...
        <div class="row" style="margin-left: 50px">
          ...
          <form method="post" action="editslider" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input type="text" id="id_slider" name="id_slider" class="form-control hide" value="<?php echo $id ?>">
              <label class="col-sm-2 control-label">Judul</label>
              <div class="col-sm-5">
              <textarea name="judul_slider"  class="form-control" id="textarea"><?php echo $judul_slider ?></textarea>
              </div>

              <div style="padding: 30px"></div>
              <label class="col-sm-2 control-label">Konten</label>
              <div class="col-sm-5">
              <textarea name="konten_slider" value="" class="form-control" id="textarea"><?php echo $konten_slider ?></textarea>
              </div>
